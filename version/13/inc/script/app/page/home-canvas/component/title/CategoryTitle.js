...
define(["require", "exports", "../../../../../lib/easelts/display/Container", "../bubble/BubbleEmitter", "app/util/PlatformProfiler", "app/data/DataManager", "../bubble/config/CategoryTitleBubbleConfig", "app/config/CanvasSettings", "./AnimatingTitle", "./AnimatingTitleMobile", "lib/easelts/geom/Size"],
    function(a, b, c, d, e, f, g, h, i, j, k) {
        var l = function(a) {
            function b() {
                a.call(this, 0, 0, 0, 0, "50%", 0),
                    this._defaultTitle = "#FEELSGOODTOBEYOU",
                    this._isEnabled = !0,
                    this._isMobile = !1,
                    this._baseY = 65,
                    this._titleY = 0,
            ...
            return __extends(b, a),
                ...
                b.prototype.show = function(a) {
                    ...
                    void 0 === a && (a = !1),
                        ...
                        a ? (this.applyPositionProperties(), this._autoResize = !0) : new TimelineMax({
                ...
                b.prototype.enable = function() {
                    this._isEnabled || (this._currentCategory ? this._title.setText(this._currentCategory.pageTitle) : this._title.setText(this._defaultTitle), this._isEnabled = !0)
                },
                b.prototype.disable = function() {
                    this._isEnabled && (this._title.setText(""), this._isEnabled = !1)
                },
                b.prototype.emitBubbles = function(a) {
                    void 0 === a && (a = 0),
                    this._isMobile || (this._smallEmitter.y = this._title.y + this._title.height - 5 + a, this._smallEmitter.width = this._title.width - 40, this._smallEmitter.startEmitting(500))
                },
                ...
                b.prototype.updatePositionProperties = function() {
                    if (!this._isMobile) {
                        ...
                        if (a.width > 400) var b = a.width - 300,
                            c = Math.min(b / this._title.width, 1);
                        else var c = Math.min((a.width - 100) / this._title.width, 1);
                        if (a.height > 750) {
                ...
                b.prototype.onResize = function(b) {
                    ...
                    this._autoResize && !this._isMobile && (this.updatePositionProperties(), this.applyPositionProperties())
                },
                b
        } (c);
        return l
